...
def main():
    ...
    parser.add_argument('--in-path', type=str, default='/mnt/mangrove_cut0/', help='image to test')
    parser.add_argument('--out-path', type=str, default='keys',
