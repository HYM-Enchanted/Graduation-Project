...
def main():
    ...
    parser.add_argument('--in-path', type=str, default='/mnt/mangrove_test/whole_test_npz', help='image to test')
    parser.add_argument('--out-path', type=str, default='/mnt/mangrove_test/test_output_1105',
