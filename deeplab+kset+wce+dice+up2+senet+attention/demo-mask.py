# 把output就开始保存，不做softmax也不做别的
# 这个是加上mask的信息之后做预测，诶好像不用，只是做output就可以了啊！！
#
# demo.py
#
import argparse
...
def main():
    ...
    parser.add_argument('--in-path', type=str, default='/mnt/mangrove_cut0/test-data-norm', help='image to test')
    parser.add_argument('--out-path', type=str, default='/mnt/mangrove_cut0/test-output',
                        help='mask image to save')
    parser.add_argument('--backbone', type=str, default='resnet',
                        choices=['resnet', 'xception', 'drn', 'mobilenet'],
                        help='backbone name (default: resnet)')
    parser.add_argument('--ckpt', type=str,
                        default='/mnt/project/deeplab_mobilenet_npz+kset/run/mangrove/deeplab-resnet/model_best.pth.tar',
                        help='saved model')
