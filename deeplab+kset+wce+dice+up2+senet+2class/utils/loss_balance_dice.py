...
# 这是平衡了不同种类样本的dice loss的调试过程！！！勋章！备份着
...
class SegmentationLosses(object):
    ...
    def Multi_loss(self,logit, target):
        ...
        # print('rate:',rate,'\n')
        print('\n====================')
        duibi_class_dice = [class_dice[i] * 0.25 for i in range(len(balance_weight))]
        print('class dice:',duibi_class_dice,'\n')
        print('sum class dice:',sum(duibi_class_dice),'\n')
