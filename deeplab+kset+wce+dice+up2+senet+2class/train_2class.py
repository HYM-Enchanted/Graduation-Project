...
class Trainer(object):
    def __init__(self, epoch, index_list, args):
        ...
        self.balance_m_weights = np.array([1])
    ...
    def validation(self, epoch):  # 验证集，每10个epoch求平均
        ...
        # print('epoch {} miou balanced weight : {}'.format(epoch,self.balance_m_weights))  # 因为2分类只有一个weight了就不用算balance了
